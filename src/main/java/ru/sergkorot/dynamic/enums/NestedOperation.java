...
public enum NestedOperation {
    ...
    IN("in") {
        @Override
        public <T> Specification<T> buildQuery(Root<T> subRoot, String fieldName, Subquery<Object> subquery, CriteriaBuilder criteriaBuilder) {
    ...
    public abstract <T> Specification<T> buildQuery(Root<T> subRoot,
                                                    String fieldName,
